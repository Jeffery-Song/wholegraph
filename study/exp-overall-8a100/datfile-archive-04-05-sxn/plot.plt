...
set terminal svg size 1600,600 font "Helvetica,16" enhanced background rgb "white" dl 2
...
app_str = "unsup unsup unsup sup sup sup"
ds_str = "PA CF MAG PA CF MAG MAG"
bs_str = "2000 2000 2000 8000 8000 8000"

app_str = "unsup unsup unsup unsup unsup sup sup sup"
ds_str = "PA CF PA CF MAG PA CF MAG MAG"
bs_str = "2000 2000 4000 4000 2000 8000 8000 8000"
...
plot \
    ...
    ,cmd_filter_dat_by_policy("_".app, ds, bs, "^Coll")         using (column(col_cache_percent) > cache_percent_lb ? column(col_cache_percent) : 1/0):(column(col_step_time_feat_copy)*1000)     w lp ps 0.5 lw 1 lc 1 title "Coll" \
    ...
    ,cmd_filter_dat_by_policy("_".app, ds, bs, "WG")            using (column(col_cache_percent) > cache_percent_lb ? column(col_cache_percent) : 1/0):(column(col_step_time_feat_copy)*1000)     w lp ps 0.5 lw 1 lc 4 title "WG" \
    ...
    # ,cmd_filter_dat_by_policy("_".app, ds, bs, "MPSPhaseRep")   using (column(col_cache_percent) > cache_percent_lb ? column(col_cache_percent) : 1/0):(column(col_step_time_feat_copy)*1000)     w lp ps 0.5 lw 3 lc 3 title "MPSRep" \
    # ,cmd_filter_dat_by_policy("_".app, ds, bs, "MPSPhaseCliq")  using (column(col_cache_percent) > cache_percent_lb ? column(col_cache_percent) : 1/0):(column(col_step_time_feat_copy)*1000)     w lp ps 0.5 lw 3 lc 2 title "MPSCliqPart" \
