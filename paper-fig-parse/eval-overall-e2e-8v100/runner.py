...
# fixme: slower coll on large cache
# cfg_list_collector.concat(cur_common_base.copy().override('dataset', [Dataset.papers100M_undir, ]).override('cache_percent', lastof(pg(1,2,1) + pg(4,20,4) + [0.25])).override('batchsize', [4000]))
# cfg_list_collector.concat(cur_common_base.copy().override('dataset', [Dataset.friendster,       ]).override('cache_percent', lastof(pg(1,2,1) + pg(4,20,4) + [0.25])).override('batchsize', [4000]))
cfg_list_collector.concat(cur_common_base.copy().override('dataset', [Dataset.papers100M_undir, ]).override('cache_percent', [0.16] + lastof(pg(1,2,1) + pg(4,20,4) + [0.25])).override('batchsize', [4000]))
cfg_list_collector.concat(cur_common_base.copy().override('dataset', [Dataset.friendster,       ]).override('cache_percent', [0.16] + lastof(pg(1,2,1) + pg(4,20,4) + [0.25])).override('batchsize', [4000]))
