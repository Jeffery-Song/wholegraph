...
cfg_list_collector.concat(cur_common_base.copy().override('dataset', [Dataset.papers100M_undir, ]).override('cache_percent', lastof(pg(2,2,1) + pg(4,12,2) + pg(16,20,4) + [0.25,     ])).override('use_amp', [False]))
cfg_list_collector.concat(cur_common_base.copy().override('dataset', [Dataset.friendster,       ]).override('cache_percent', lastof(pg(2,2,1) + pg(4,12,2) + pg(16,20,4) + [0.25, 0.40])).override('use_amp', [False]))
